...
/* Offset 0x19: IP Mapping Table */
#define MV88E6320_G1_IP_PRIO_MAP_TABLE				0x19
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_UPDATE			0x8000
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_USE_IP_FPRI		0x4000

#define MV88E6320_G1_IP_PRIO_MAP_TABLE_PTR_MASK			GENMASK(13, 8)
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_PTR_GET(p)		FIELD_GET(MV88E6320_G1_IP_PRIO_MAP_TABLE_PTR_MASK, p)
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_PTR_SET(p)		FIELD_PREP(MV88E6320_G1_IP_PRIO_MAP_TABLE_PTR_MASK, p)

#define MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_FPRI_MASK		GENMASK(6, 4)
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_FPRI_GET(p)		FIELD_GET(MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_FPRI_MASK, p)
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_FPRI_SET(p)		FIELD_PREP(MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_FPRI_MASK, p)

#define MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_QPRI_MASK		GENMASK(1, 0)
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_QPRI_GET(p)		FIELD_GET(MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_QPRI_MASK, p)
#define MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_QPRI_SET(p)		FIELD_PREP(MV88E6320_G1_IP_PRIO_MAP_TABLE_IP_QPRI_MASK, p)
