...
#define MV88E6390_TAI_CFG_BLOCK_UPDATE		0x0008
#define MV88E6352_TAI_CFG_TIME_INC_DEC_EN	0x0008
...
/* Pulse width in cycles, in one-shot mode */
#define MV88E6XXX_TAI_TRIG_CFG_PULSE_WIDTH_MASK		GENMASK(15, 12)
#define MV88E6XXX_TAI_TRIG_CFG_PULSE_WIDTH_GET(p)	FIELD_GET(MV88E6XXX_TAI_TRIG_CFG_PULSE_WIDTH_MASK, p)
#define MV88E6XXX_TAI_TRIG_CFG_PULSE_WIDTH_SET(p)	FIELD_PREP(MV88E6XXX_TAI_TRIG_CFG_PULSE_WIDTH_MASK, p)

/* Amount to increment or decrement PTP global time */
#define MV88E6XXX_TAI_TRIG_TIME_INC_DEC_OP		0x0800
#define MV88E6XXX_TAI_TRIG_TIME_INC_DEC_AMT_MASK	GENMASK(10, 0)
#define MV88E6XXX_TAI_TRIG_TIME_INC_DEC_AMT_GET(p)	FIELD_GET(MV88E6XXX_TAI_TRIG_TIME_INC_DEC_AMT_MASK, p)
#define MV88E6XXX_TAI_TRIG_TIME_INC_DEC_AMT_SET(p)	FIELD_PREP(MV88E6XXX_TAI_TRIG_TIME_INC_DEC_AMT_MASK, p)
...
/* Offset 0x13: Trig Generation Delay */
#define MV88E6XXX_TAI_TRIG_DELAY		0x13

/* Offset 0x14/0x15: Trig Generation 2 Time */
#define MV88E6XXX_TAI_TRIG2_TIME_LO		0x14
#define MV88E6XXX_TAI_TRIG2_TIME_HI		0x15

/* Offset 0x16: Lock 2 Status */
#define MV88E6XXX_TAI_LOCK2_STATUS		0x16

/* Offset 0x17: Trig Generation 2 Delay */
#define MV88E6XXX_TAI_TRIG2_DELAY		0x17
