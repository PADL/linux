...
struct mv88e6xxx_tc_policy {
	/* Number of reserved stream AVB MC memberships in ATU */
	refcount_t avb_mdb_count;

	/* Current MQPRIO mode */
	enum mv88e6xxx_tc_mode tc_mode;

	/* Ports participating in global FPri/QPri mapping */
	u16 port_mask;
...
struct mv88e6xxx_chip {
	...
	/* Global AVB traffic class mappings for MQPRIO DCB mode */
...
struct mv88e6xxx_ops {
	 ...
	 * or an array of TC_BITMASK + 1 frame priorities.
	 */
