...
struct mv88e6xxx_info {
	 ...
	 * field of the PTP common header, which the dsa-ptp-reserved2-ts and
	 * edsa-ptp-reserved2-ts tag protocols select. Otherwise arrival time
	 * stamps are only available from the switch registers.
	 */
...
{
	return chip->tag_protocol == DSA_TAG_PROTO_DSA_PTP_RESERVED2_TS ||
